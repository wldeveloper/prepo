...
const argv = require('yargs').usage(`Usage: ${CMD} [root] [options]`).example(`${CMD} root -rb`, 'pull repository').boolean('r').alias('r', 'recursive').describe('r', 'pull repository recursive').boolean('b').alias('b', 'bail').describe('b', 'exit process when error').help('h').alias('h', 'help').argv;
